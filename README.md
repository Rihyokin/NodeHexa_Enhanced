...
| 模块              | 说明                      | 详细文档                                                                 |
| --------------- | ----------------------- | -------------------------------------------------------------------- |
| **Xbox 蓝牙手柄**   | BLE 无线控制，摇杆/扳机/按钮全映射    | [XBOX\_GAMEPAD\_DEVELOPMENT.md](XBOX_GAMEPAD_DEVELOPMENT.md)         |
| **OpenMV 视觉模块** | 实时图像采集，WiFi 图传至桌面应用     | [CHANGELOG\_OPENMV\_INTEGRATION.md](CHANGELOG_OPENMV_INTEGRATION.md) |
| **桌面控制应用**      | PyQt5 GUI，实时画面显示 + 键鼠操控 | [DESKTOP\_CONTROL\_SOFTWARE.md](DESKTOP_CONTROL_SOFTWARE.md)         |
...
> 详见 [XBOX\_GAMEPAD\_DEVELOPMENT.md](XBOX_GAMEPAD_DEVELOPMENT.md)
...
> 详见 [CHANGELOG\_OPENMV\_INTEGRATION.md](CHANGELOG_OPENMV_INTEGRATION.md)
...
> 详见 [DESKTOP\_CONTROL\_SOFTWARE.md](DESKTOP_CONTROL_SOFTWARE.md)
...
2. 机器人开机后连接 WiFi 热点 `NodeHexa` (密码: `12345678`)
